  ...
  return (
    <div className={styles.loginCard}>
      <div className={styles.loginHeader}>
        ...
        <p>
          {isRegister
            ? 'Join Wishme and start creating beautiful cards'
            : 'Sign in to create personalized greeting cards'}
        </p>
      </div>

      {error && <div className={styles.error} id="auth-error">{error}</div>}
      ...
      <div className={styles.toggleMode}>
        ...
        <button onClick={() => { setIsRegister(!isRegister); setError(''); }} type="button">
